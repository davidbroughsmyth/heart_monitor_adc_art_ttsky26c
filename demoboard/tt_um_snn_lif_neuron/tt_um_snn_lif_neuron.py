...
"""
Hardware-in-the-loop tests for tt_um_snn_lif_neuron.

Combined HIL: enable the SNN; RP2350 synthesizes ADC samples + sample_en
(as if heart_monitor_adc were wired in). Patterned after tt-micropython-firmware
examples.
"""
