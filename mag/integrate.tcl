...
# Keep Mag/GDS hierarchical — do NOT flatten (avoids weird TT Magic DRC issues).
...
# Local met4 straps (start at x>=10 to avoid bridging VDPWR@1µm / VGND@4µm pins)
box 10um 80um 70um 82um
paint met4
box 10um 90um 70um 92um
paint met4
...
file mkdir ../gds
file mkdir ../lef
# Hierarchical GDS (include child geometry; never flatten the .mag)
